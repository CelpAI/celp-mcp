...
exports.StreamingDatabaseClient = void 0;
/**
...
class StreamingDatabaseClient {
     ...
     */
    async queryDatabase(prompt, databaseConnection, callbacks) {
        try {
...
exports.StreamingDatabaseClient = StreamingDatabaseClient;
// Example usage
async function exampleUsage() {
    // Create a client instance
    const client = new StreamingDatabaseClient('http://localhost:3000', 'your-api-key-here');
    ...
    await client.queryDatabase('What are the top 10 customers by revenue?', dbConnection, {
        onProgress: (data) => {
